        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-primary shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-focus"
            />{" "}
          </div>{" "}
